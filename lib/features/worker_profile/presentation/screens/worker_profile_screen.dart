  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: <BlocProvider<dynamic>>[
        BlocProvider<WorkerProfileCubit>(
          create: (_) => locator<WorkerProfileCubit>()..loadProfile(),
        ),
...
class WorkerProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<WorkerProfileCubit, WorkerProfileState>(
      builder: (BuildContext context, WorkerProfileState state) {
        return Scaffold(
          ...
          body: AppLoadingOverlay(
            ...
            child: state.profile == null
                ? AppRetryWidget(
                    ...
                    onRetry: context.read<WorkerProfileCubit>().loadProfile,
                  )
